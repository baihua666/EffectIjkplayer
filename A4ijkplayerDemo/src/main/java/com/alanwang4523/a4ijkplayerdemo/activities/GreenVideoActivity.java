...
public class GreenVideoActivity extends AppCompatActivity implements TracksFragment.ITrackHolder {
    ...
    public static Intent newIntent(Context context, String videoPath, String videoTitle) {
        Intent intent = new Intent(context, GreenVideoActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_green_video);
        ...
        findViewById(R.id.matting_button).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mVideoView.setMattingGreenEnabled(!mVideoView.getMattingGreenEnabled());

                findViewById(R.id.matting_button).bringToFront();
            }
        });
    }
